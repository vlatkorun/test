...
class CreatedAt implements CriteriaInterface, NeedsSearchValueInterface
{
    protected $dateFrom;
    protected $dateTo;
    ...
    public function apply($model, RepositoryInterface $repository)
    {
        ...
        {
            $model = $model->whereBetween('created_at', [$this->dateFrom->format('Y-m-d'), $this->dateTo->format('Y-m-d')]);
        }
